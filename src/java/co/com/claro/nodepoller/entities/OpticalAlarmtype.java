 ...
 */
@Entity
@Table(name = "optical_alarmtype")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "OpticalAlarmtype.findAll", query = "SELECT o FROM OpticalAlarmtype o")
    , @NamedQuery(name = "OpticalAlarmtype.findById", query = "SELECT o FROM OpticalAlarmtype o WHERE o.id = :id")
    , @NamedQuery(name = "OpticalAlarmtype.findByName", query = "SELECT o FROM OpticalAlarmtype o WHERE o.name = :name")})
public class OpticalAlarmtype implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OpticalAlarmtype)) {
            return false;
        }
        OpticalAlarmtype other = (OpticalAlarmtype) object;
    ...
    public String toString() {
        return "co.com.claro.nodepoller.entities.OpticalAlarmtype[ id=" + id + " ]";
    }
